  ...
  return (
    <form action={formAction} noValidate className="space-y-4">
      ...
      <FormInput
        ...
        type="email"
        autoComplete="email"
        placeholder={dict.auth.emailPlaceholderRegister}
      ...
      <FormInput
        ...
        placeholder={dict.auth.passwordPlaceholderRegister}
      ...
      <div className="pt-2">
        <SubmitButton label={dict.auth.registerButton} loadingLabel={dict.auth.registerLoading} />
      </div>
